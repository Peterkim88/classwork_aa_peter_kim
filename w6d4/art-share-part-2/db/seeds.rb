...
Comment.create!(body: 'comment1', user_id: mike.id, artwork_id: artwork5.id)
Comment.create!(body: 'comment2', user_id: chris.id, artwork_id: artwork8.id)
Comment.create!(body: 'comment3', user_id: paulo.id, artwork_id: artwork10.id)
Comment.create!(body: 'comment4', user_id: taylor.id, artwork_id: artwork2.id)
Comment.create!(body: 'comment5', user_id: sam.id, artwork_id: artwork4.id)
Comment.create!(body: 'comment6', user_id: jack.id, artwork_id: artwork7.id)
Comment.create!(body: 'comment7', user_id: mike.id, artwork_id: artwork2.id)
Comment.create!(body: 'comment8', user_id: chris.id, artwork_id: artwork3.id)
Comment.create!(body: 'comment9', user_id: paulo.id, artwork_id: artwork6.id)
Comment.create!(body: 'comment10', user_id: mike.id, artwork_id: artwork8.id)
Comment.create!(body: 'comment11', user_id: chris.id, artwork_id: artwork2.id)
Comment.create!(body: 'comment12', user_id: paulo.id, artwork_id: artwork4.id)
Comment.create!(body: 'comment13', user_id: taylor.id, artwork_id: artwork6.id)
Comment.create!(body: 'comment14', user_id: sam.id, artwork_id: artwork9.id)
Comment.create!(body: 'comment15', user_id: jack.id, artwork_id: artwork10.id)