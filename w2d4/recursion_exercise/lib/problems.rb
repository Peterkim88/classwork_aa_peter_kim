...
# def pow(base, exponent) #(3, 4)
#     return 1 if exponent == 0
#     base * pow(base, exponent - 1)
#     {base * pow(base, exponent - 1) 3, 3
#     * pow(base, exponent - 1) 3, 2
#     * pow(base, exponent - 1) 3, 1
#     * pow(base, 0)} = 1
#     # total = 1
#     # i = 0
#     # while i < exponent
...
def sum_array(array)
    ...
    last_num = array[array.length - 1]
    rest = array[0...array.length - 1]
    last_num + sum_array(rest)
end
...
def reverse_string(str)
    ...
    new_str = str[-1]
    rest = str[0...str.length - 1]
    new_str += reverse_string(rest)
end
...
def flatten(data)
    ...
    new_data = []
    data.each { |el| new_data += flatten(el) }
    new_data
end
